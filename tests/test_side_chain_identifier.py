...
# Will uncomment these once merged into main (see below under test_aa_monomers)
...
def test_aa_monomers():
    # Will implement this test once merged into main, so that we can use the
    # monomers from Bushman's branch.
